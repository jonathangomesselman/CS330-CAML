...
echo "MNIST Rotations:"
python3 main.py $ROT $seed --model caml1 --lr 0.1 --beta 0.03 --gamma 1.0 --memories 128 --replay_batch_size 5 --batches_per_example 5 --caml_priority newest --softmax_temperature 0.01