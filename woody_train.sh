...
echo "CAML Saliency:"
echo "MNIST Rotations:"
python3 saliency.py $ROT $seed --model caml1 --lr 0.1 --beta 0.03 --gamma 1.0 --memories 128 --replay_batch_size 5 --batches_per_example 5 --caml_priority dynamic --softmax_temperature 0.88 --s 1

# echo "Online Saliency" "( seed =" $seed ")"
# echo "MNIST Rotations:"
# python3 saliency.py $ROT $seed --model online --lr 0.1