...
seed=1
ROT="--n_layers 2 --n_hiddens 100 --data_path data/ --save_path verify_milestone_results/ --batch_size 1 --log_every 100 --samples_per_task 10 --data_file mnist_rotations.pt --cuda no --seed"
...
echo "MNIST Rotations:"
python3 main.py $ROT $seed --model caml1 --lr 0.1 --beta 0.03 --gamma 1.0 --memories 128 --replay_batch_size 5 --batches_per_example 5 --caml_priority loss --softmax_temperature 0.01 --s 5